...
<body class="page-child">
    ...
    <main id="main-site">
        <section class="sec-main-page">
             <div class="wp-titlle-tin-page hidden-xs" style="background: url({{asset('public/images-demo/venus-charm-cover.jpg')}});background-size: cover">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 blog-item">
                            <div class="wp-item-tin-a">
                                <div class="wp-img-tin-a img-cover">
                                    <a href="">
                                        <img src="{{asset('public/images-demo/vn4-1-.jpg')}}" alt="SÓNG TỚI, THÌ MÌNH MỞ CỬA HÀNG MỚI!">
                                    </a>
                                </div>
                                <div class="wp-text-tin-a">
                                    <h3 class="h3-title" style="line-height: 17px">
                                        <a href="">SÓNG TỚI, THÌ MÌNH MỞ CỬA HÀNG MỚI!</a>
                                    </h3>
                                    <div style="" class="desssss">Sóng tới, Venus Charm lại một lần nữa "chuyển mình". Để trở thành... </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 blog-item">
                            <div class="wp-item-tin-a">
                                <div class="wp-img-tin-a img-cover">
                                    <a href="">
                                        <img src="{{asset('public/images-demo/vn4-1-.jpg')}}" alt="Phụ Nữ Hiện Đại - Đừng Ngại Yêu Chính Mình!">
                                    </a>
                                </div>
                                <div class="wp-text-tin-a">
                                    <h3 class="h3-title" style="line-height: 17px">
                                        <a href="">Phụ Nữ Hiện Đại - Đừng Ngại Yêu Chính Mình!</a>
                                    </h3>

                                    <div style="" class="desssss">Nội y, giờ đây đã vượt khỏi tầm thời trang hay một món đồ thực... </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 blog-item">
                            <div class="wp-item-tin-a">
                                <div class="wp-img-tin-a img-cover">
                                    <a href="">
                                        <img src="{{asset('public/images-demo/vn4-1-.jpg')}}" alt="BLACK FRIDAY | SALE CỰC TO - GIÁ CỰC NHỎ - CHỈ TỪ 29K!">
                                    </a>
                                </div>
                                <div class="wp-text-tin-a">
                                    <h3 class="h3-title" style="line-height: 17px">
                                        <a href="">BLACK FRIDAY | SALE CỰC TO - GIÁ CỰC NHỎ - CHỈ TỪ 29K!</a>
                                    </h3>
                                    <div style="" class="desssss">Chương trình SALE LỚN NHẤT trong năm cuối cùng đã tới, dừng chân và... </div>
                                </div>
                            </div>
                        </div>
                    </div>
