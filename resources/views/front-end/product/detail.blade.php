                                ...
                                <div class="price-ctsp">
                                    <div class="price-ctsp">
                                        @if($product->sale_price)
                                            ...
                                            <span class="span-gia"
                                                  style="text-decoration: line-through;color: #333333;font-weight: normal;font-size: 14px;">
                                ...
                                <div class="wp-chonmau add_bag_color">
                                    @if($product->product_attributes)
                                        <ul class="nav nav-pills">
                                            @foreach($product->product_attributes as $pr_at)
                                                <li class="chose_attr_advanced_color @if ($loop->first) active @endif"
                                                    data-color="{{ $pr_at['pav1_id'] }}"
                                                    data-sizeids="{{ $pr_at['sizeids'] }}|"
                                                    data-title="{{ $pr_at['pav1_name'] }}">
                                                    <a class="" data-toggle="pill"
                                                       href="#img-id{{$product->id}}{{$pr_at['pav1_id']}}"
                                                       data-red=".img-id{{$product->id}}{{$pr_at['pav1_id']}}">
                                                    <!--  <img class="imgAuto" src="{{$pr_at['image_path']}}"> -->
                                                        <span class="color color4"
                                                              style="background: url('{{$pr_at['image_path']}}')"></span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        </ul>
                                        ...
                                        <div class="wp-top-text-sp-22">
                                            ...
                                            <div class="wp-chonmau">
                                                @if($product->product_attributes)
                                                    <ul class="nav nav-pills">
                                                        @foreach($product->product_attributes as $pr_at)
                                                            <li class="chose_attr_advanced_color chose_attr_advanced_mobile @if ($loop->first) active @endif"
                                                                data-color="{{ $pr_at['pav1_id'] }}"
                                                                data-sizeids="{{ $pr_at['sizeids'] }}|"
                                                                data-title="{{ $pr_at['pav1_name'] }}">
                                                                <a class="s_color" data-toggle="pill"
                                                                   href="#img-id1{{$product->id}}{{$pr_at['pav1_id']}}"
                                                                   data-reds=".img-id1{{$product->id}}{{$pr_at['pav1_id']}}">
                                                                <!--  <img class="imgAuto" src="{{$pr_at['image_path']}}"> -->
                                                                    <span class="color color4"
                                                                          style="background: url('{{$pr_at['image_path']}}')"></span>
                                                                </a>
                                                    ...
                                                    <form id="rateform"
                                                        ...
                                                        <div class="wpdg1 form-group">
                                                            ...
                                                            <span class="starRating stars">
                                                                <input value="5" class="star star-5" id="star-4-5"
                                                                       type="radio" name="star" data-value="5"/>
                                                                <label class="star star-5" for="star-4-5"></label>
                                                                <input value="4" class="star star-4" id="star-4-4"
                                                                       type="radio" name="star" data-value="4"/>
                                                                <label class="star star-4" for="star-4-4"></label>
                                                                <input value="3" class="star star-3" id="star-4-3"
                                                                       type="radio" name="star" data-value="3"/>
                                                                <label class="star star-3" for="star-4-3"></label>
                                                                <input value="2" class="star star-2" id="star-4-2"
                                                                       type="radio" name="star" data-value="2"/>
                                                                <label class="star star-2" for="star-4-2"></label>
                                                                <input value="1" class="star star-1" id="star-4-1"
                                                        ...
                                                        <div class="wpdg3 form-group">
                                                            ...
                                                            <input title="Số điện thoại" name="phone" id="rate-phone"
                                                                   class="form-control"
                                                        ...
                                                        <div class="wpdg3 form-group">
                                                            ...
                                                            <input title="Nhập địa chỉ Email" name="email"
                                                                   id="rate-email"
                                                        ...
                                                        <div class="wpdg2 form-group">
                                                            ...
                                                            <textarea rows="5" title="Nhập nội dung đánh giá / nhận xét"
                                                                      name="message"
                                                                      id="rate-content"
                                                                      placeholder="Nhập nội dung đánh giá / nhận xét..."
                                                                      class="form-control"
                                                                      aria-required="true"></textarea>
                                                        </div>
                                                        <button class="btn btn-danger" type="submit">Gửi đánh giá
                                                        </button>
                                            ...
                                            <div class="modal-body">
                                                <div class="wp-cauhoi">
                                                    ...
                                                    <form action="#"
                                                        ...
                                                        <button class="btn btn-danger" type="submit">Gửi câu hỏi
                                                        </button>
