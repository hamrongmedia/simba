        ...
        <div class="container">
            ...
            <div class="wp-img-ctsp hidden-xs">
                <div class="row" style="position: relative;">
                            ...
                            <div class="tab-content">
                                @if($product->product_attributes)
                                    @foreach($product->product_attributes as $pr_at)
                                        <div id="img-id{{$product->id}}{{$pr_at['pav1_id']}}" class="tab-pane fade @if($loop->first) active in @endif  img-id{{$product->id}}{{$pr_at['pav1_id']}} tab-images">
                                            ...
                                            @else
                                                <div class="wp-sautab img-cover">
                                                    <a href="{{ $product->thumbnail }}" data-fancybox>
                    ...
                    <div class="col-md-5 col-sm-6 col-xs-12 pca-pl-r fixed-menu" >
