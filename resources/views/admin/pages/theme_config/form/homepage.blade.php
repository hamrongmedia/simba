        ...
        <div class="tab-pane" id="tab_2">
            <div class="form-group">
              ...
              <label for="">Nhập ảnh </label>
                @if($value != null && isset($value->home2_background1))
                  @include('admin.component.image_button', ['name' => 'home2_background1', 'id' => 'home2_background1_btn', 'value' => $value->home2_background1, 'holder' => 'home2_background1_holder','holder_img' => $value->home2_background1])
                @else
                  @include('admin.component.image_button', ['name' => 'home2_background1', 'id' => 'home2_background1_btn', 'value' => '', 'holder' => 'home2_background1_holder'])
                @endif
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @if($value != null && isset($value->home2_background2))
                  @include('admin.component.image_button', ['name' => 'home2_background2', 'id' => 'home2_background2_btn', 'value' => $value->home2_background2, 'holder' => 'home2_background2_holder','holder_img' => $value->home2_background2])
                @else
                  @include('admin.component.image_button', ['name' => 'home2_background2', 'id' => 'home2_background2_btn', 'value' => '', 'holder' => 'home2_background2_holder'])
                @endif
            </div>
            <div class="form-group">
              <label for="">Nhập mô tả </label>
        ...
        <div class="tab-pane" id="tab_3">
            <div class="form-group">
                ...
                @if($value != null && isset($value->home3_background))
                  @include('admin.component.image_button', ['name' => 'home3_background', 'id' => 'home3_background_btn', 'value' => $value->home3_background, 'holder' => 'home3_background_holder','holder_img' => $value->home3_background])
                @else
                  @include('admin.component.image_button', ['name' => 'home3_background', 'id' => 'home3_background_btn', 'value' => '', 'holder' => 'home3_background_holder'])
                @endif
            </div>
            <div class="form-group">
              <label for="">Nhập mô tả </label>
        ...
        <div class="tab-pane" id="tab_5">
          ...
          <div class="form-group col-xs-6">
                ...
                @if($value != null && isset($value->home5_background))
                  @include('admin.component.image_button', ['name' => 'home5_background', 'id' => 'home5_background_btn', 'value' => $value->home5_background, 'holder' => 'home5_background_holder','holder_img' => $value->home5_background])
                @else
                  @include('admin.component.image_button', ['name' => 'home5_background', 'id' => 'home5_background_btn', 'value' => '', 'holder' => 'home5_background_holder'])
                @endif
          </div>
        ...
        <div class="tab-pane" id="tab_10">
          ...
          <div class="form-group col-xs-6">
                ...
                @if($value != null && isset($value->home10_background))
                  @include('admin.component.image_button', ['name' => 'home10_background', 'id' => 'home10_background_btn', 'value' => $value->home10_background, 'holder' => 'home10_background_holder','holder_img' => $value->home10_background])
                @else
                  @include('admin.component.image_button', ['name' => 'home10_background', 'id' => 'home10_background_btn', 'value' => '', 'holder' => 'home10_background_holder'])
                @endif
          </div>
          <div class="form-group col-xs-3">
            <label for="">Chọn ID sản phẩm</label>
