            ...
            <div class="box-header with-border">
                <div class="pull-right">
                    <div class="menu-right">
                        <form action="{{route('admin.product_question.search')}}" id="button_search">
...
<script>
    ...
    function deleteAjax(id) {
        $.ajax({
            url: "{{route('admin.product_question.delete')}}",
            type: 'POST',
            data: {
                id: id
            }
    ...
    function searchAjax(page = 1){
        ...
        $.ajax({
            url: '{{route("admin.product_question.search")}}' ,
            data:{
                keyword: input,
                current_page:page,
            }
    ...
    function sortAjax(current_page = 1) {
        ...
        $.ajax({
            url: "{{route('admin.product_question.index')}}",
            data: {
                sort_by: input[0],
                sort_type: input[1],
