  ...
  <div class="col-xs-12">
    <div class="box">
        ...
        <div class="box-header with-border">
          <div class="pull-right">
              <div class="menu-right">
                  <form action="{{route('admin.category.search')}}" id="button_search">
      ...
      <div class="box-header with-border">
          <div class="pull-right">
              <div class="menu-right">
                      <a href="{{route('admin.category.create')}}" class="btn  btn-success  btn-flat"
      ...
      <section id="pjax-container" class="table-list">
        @include('admin.pages.ajax_components.category_table')
