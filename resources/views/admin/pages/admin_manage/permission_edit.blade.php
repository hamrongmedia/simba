...
<div class="row">
  <div class="col-md-12">
      <div class="box">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{route('admin.permission.update', ['id' => $permission->id])}}" method="post" accept-charset="UTF-8"
              ...
              <div class="box-body">
                  <div class="fields-group">
                      ...
                      <div class="form-group  kind kind0 kind1 ">
                          <label for="http_uri" class="col-sm-2  control-label">Select action</label>
                          ...
                          <div class="col-sm-8">
                              <select class="form-control input-sm http_uri select2 select2-hidden-accessible"
                                  ...
                                  @foreach ($actions as $action)
                                    @if ($permission->actions->contains('id', $action->id))
