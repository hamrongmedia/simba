...
@section('title','Quản lý trạng thái vận chuyển')
@section('main')
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-header with-border">
          <div class="pull-right">
              <div class="menu-right">
                      <a href="{{route('admin.shipping_status.create')}}" class="btn  btn-success  btn-flat"
...
<script>
    function deleteItem( id) {
        Swal.fire({
            title: 'Warning',
            text: "Bạn có chắc muốn xóa trạng thái vận chuyển này?",
            icon: 'warning',
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        Swal.fire(
                            ...
                            'Bạn đã xóa trạng thái vận chuyển thành công.',
                            'success'
                        );
    ...
    function restoreItem( id, title= 'Are You Sure?') {
      ...
      Swal.fire({
          ...
          text: "Bạn muốn khôi phục trạng thái vận chuyển này!",
          icon: 'warning',
          showCancelButton: true,
          confirmButtonColor: '#3085d6',
          cancelButtonColor: '#d33',
      ...
      .then((result) => {
        if (result.value) {
          $.ajax({
              ...
              Swal.fire(
                  'Thành công!',
                  'Bạn đã khôi phục trạng thái vận chuyển thành công.',
                  'success',
              );
              window.location.reload();
          })
