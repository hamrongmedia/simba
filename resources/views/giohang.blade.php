        ...
        <div class="container">
            <div class="wp-header-thanhtoan">
                <div class="wp-logo-fft">
                    <a href=""><img src="{{asset('public/images/logo.png')}}" alt="Venus Charm"></a>
                </div>
                    ...
                    <div class="wp-right-tt">
                        <div class="wp-list-sp">
                            <ul class="ul-b list-sp-tt">
                                <li class="item-sp-tt">
                                    <div class="img-sp-tt">
                                        <a href="ao-freedom-1805-p846.html"><img src="{{asset('public/images-demo/1590838844.jpg')}}" alt="Áo Freedom 1805"></a>
                                    </div>
